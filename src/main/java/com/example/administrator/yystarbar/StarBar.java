package com.example.administrator.yystarbar;
...
public class StarBar extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        setClickable(true);
        TypedArray mTypedArray = context.obtainStyledAttributes(attrs, R.styleable.app);
        this.starDistance = (int) mTypedArray.getDimension(R.styleable.app_starDistance, 0);
        this.starSize = (int) mTypedArray.getDimension(R.styleable.app_starSize, 20);
        this.starCount = mTypedArray.getInteger(R.styleable.app_starCount, 5);
        this.starEmptyDrawable = mTypedArray.getDrawable(R.styleable.app_starEmpty);
        this.starFillBitmap = drawableToBitmap(mTypedArray.getDrawable(R.styleable.app_starFill));
        mTypedArray.recycle();
